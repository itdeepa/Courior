...
public class BkngConsDto implements Serializable{
	...
	private Object fileDataArr;
	private String fileDataName;
	private String showDestbrn="";
	...
	public Object getFileDataArr() {
		return fileDataArr;
	}
	public void setFileDataArr(Object fileDataArr) {
		this.fileDataArr = fileDataArr;
	}
